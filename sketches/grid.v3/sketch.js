...
let spacing = 160; //spacing between the rectangles in the grid, will be set based on the selected size mode
...
let imagePath = 'assets/glyphs-v2.png'; //path to the sprite sheet image, will be used to load the glyphs for the grid objects
let sheet;
let glyphs = [];
...
let randomChangeMin = 1; //minimum number of grid objects to change in each batch, can be adjusted to control the speed of the animation
let randomChangeMax = 5; //maximum number of grid objects to change in each batch, can be adjusted to control the speed of the animation
let randomFillMin = 200; //minimum fill color value, can be adjusted to control the range of colors
let randomFillMax = 220; //maximum fill color value, can be adjusted to control the range of colors
...
class GridObject {
    ...
    scheduleChange(delay) {
        this.pendingFill = random(randomFillMin, randomFillMax); //randomly select a new fill color for the object
...
function changeGridObjects() {
    let randomChange = random(randomChangeMin, randomChangeMax);
    let lastDelay = 0;
...
async function setup() {
    ...
    sheet = await loadImage(imagePath); //load the sprite sheet image and wait for it to finish loading before proceeding
